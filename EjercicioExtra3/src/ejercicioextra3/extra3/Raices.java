...
package ejercicioextra3.extra3;
...
public class Raices {
    ...
    public boolean tieneRaices( double discriminante){
       ...
       if(discriminante>=0){
           ...
           System.out.println("Tiene raices: "+ traices);
    ...
    public boolean tieneRaiz(double discriminante){
        ...
        if( discriminante ==0 ){
            ...
            System.out.println("Tiene raiz: "+ traiz);
    ...
    public double[] obtenerRaices(){
        ...
        if(tieneRaices(getDiscriminante(a, b, c))==true){
            
            x[1] = (-b+Math.sqrt((Math.pow(b, 2))-(4*a*c)))/(2*a);
            
            x[2] = (-b-Math.sqrt((Math.pow(b, 2))-(4*a*c)))/(2*a);
    ...
    public double obtenerRaiz(){
        ...
        if(tieneRaiz(getDiscriminante(a, b, c))==true){
